...
public class Level3 extends GameLevel {
    ...
    public void draw() {
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 0, 19);
        // final lado esquerdo
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 1, 19);
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 1, 0);
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 19, 1);
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 19, 18);
        //final lado direito
        eventBus.emit("create-element", wall);
        //bordas do mapa
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 5, 2);
        eventBus.emit("create-element", wall);
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 6, 11);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 6, 13);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 6, 15);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 5, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 6, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 7, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 7, 2);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 8, 4);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 8, 6);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 8, 9);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 8, 10);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 8, 13);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 9, 11);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 9, 15);
        eventBus.emit("create-element", wall);
        ...
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 10, 3);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 11, 6);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 11, 9);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 11, 10);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 11, 13);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 12, 2);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 12, 8);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 2);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 4);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 6);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 8);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 11);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 13);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 15);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 13, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 12, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 14, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 14, 2);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 2);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 4);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 6);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 9);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 10);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 13);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 15);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 15, 17);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 2);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 4);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 6);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 8);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 11);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 13);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 15);
        eventBus.emit("create-element", wall);
        wall = new IndestructableBlock(eventBus, 17, 17);
        eventBus.emit("create-element", wall);
        ...
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 8, 1);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 9, 1);
        eventBus.emit("create-element", block);
        ...
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 3, 2);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 8, 2);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 9, 2);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 10, 2);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 11, 2);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 2);
        eventBus.emit("create-element", block);
        ...
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 14, 3);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 15, 3);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 3);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 3);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 1, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 3, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 5, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 11, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 14, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 4);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 1, 5);
        eventBus.emit("create-element", block);
        ...
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 5);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 5);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 1, 6);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 4, 6);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 6);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 6);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 14, 6);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 6);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 2, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 6, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 16, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 7);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 4, 8);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 8);
        eventBus.emit("create-element", block);
        ...
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 9);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 9);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 13, 9);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 9);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 2, 10);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 6, 10);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 10);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 10);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 13, 10);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 10);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 4, 11);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 11);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 11);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 15, 11);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 2, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 4, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 6, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 13, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 15, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 12);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 13);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 13);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 2, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 4, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 6, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 13, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 15, 14);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 14);
        eventBus.emit("create-element", block);
        ...
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 1, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 2, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 3, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 6, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 7, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 8, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 9, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 11, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 12, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 13, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 15, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 16, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 16);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 1, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 3, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 8, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 9, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 10, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 11, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 16, 17);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 1, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 2, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 3, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 4, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 5, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 6, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 16, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 17, 18);
        eventBus.emit("create-element", block);
        block = new RegularBlock(eventBus, 18, 18);
        eventBus.emit("create-element", block);
